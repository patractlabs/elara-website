...
//     Object.keys(dayMethod).forEach((method) => {
//       sumUp[method] = sumUp[method]
//         ? sumUp[method] + parseInt(dayMethod[method] || "0")
//         : parseInt(dayMethod[method] || "0");
//     });
//   });
...
//     Promise.all([projectPromise, dayDetailPromise]).then(
//       ([project, dayDetail]) =>
//         setProject({
//           name: project.name,
...
//       bandwidthOption.series[0].data = keys.map(
//         (key) => parseInt(statMonth[key].bandwidth || "0") / 1024 / 1024
//       );

//       methodsCallOption.series[0].data = sumUpMethodCalls(statMonth);
//       methodsCallOption.series[0].data = !methodsCallOption.series[0].data
//         .length
//         ? [{ name: "Null", value: 0 }]
...
//               key: "name",
//               render: (text: string) => (
//                 <span className="td-span-default">{text}</span>
//               ),
//               width: 150,
//             },
//             {
...
//               key: "createtime",
//               render: (text: string) => (
//                 <span className="td-span-default">{formatTime(text)}</span>
//               ),
//               width: 150,
//             },
//             {
...
//               key: "request",
//               render: (text: string) => (
//                 <span className="td-span-active">{text}</span>
//               ),
//               width: 150,
//             },
//             {
...
//               key: "bandwidth",
//               render: (text: number) => (
//                 <span className="td-span-active">{formatSize(text)}</span>
//               ),
//               width: 150,
//             },
//             {
...
//                   ) : (
//                     <img
//                       src={DeactiveStatusSVG}
//                       alt=""
//                       style={{ marginRight: "8px" }}
//                     />
//                   )}
//                   {text === ProjectStatus.Active ? (
//                     <span className="td-span-active">
//                       {t("listPage.Status-Active")}
//                     </span>
//                   ) : (
//                     <span className="td-span-default">
//                       {t("listPage.Status-Stop")}
//                     </span>
//                   )}
//                 </div>
//               ),
...
//                 <span>
//                   {`${WSS_ENDPOINTS_URL}/${project?.chain.toLowerCase()}/${
//                     project?.pid
//                   }`}
//                 </span>
//                 <img
...
//               <div className="info-row endpoints-row">
//                 <span>{`${ENDPOINTS_URL}/${project?.chain.toLowerCase()}/${
//                   project?.pid
//                 }`}</span>
//                 <img
//                   className="copy-img"
//                   onClick={() =>
//                     copy(
//                       `${ENDPOINTS_URL}/${project?.chain.toLowerCase()}/${
//                         project?.pid
//                       }`
//                     )
//                   }
...
//           <h2 className="card-h2 methods-call-h2">
//             {t("Details.30days-callmethods")}
//           </h2>
//           <div style={{ display: "flex", justifyContent: "center" }}>
//             <div
//               ref={methodsCallEchart}
//               style={{ width: "100%", height: "355px" }}
//             />
//           </div>
//         </div>
